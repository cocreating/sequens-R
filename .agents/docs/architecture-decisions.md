...
- Text-plus-emoticon cues are limited to distinctive navigation, transport, persistence, capture, hardware, and export actions. They remain decorative to assist visual scanning without changing accessible names; dense state controls, destructive actions, and narrow mobile actions stay text-only.
