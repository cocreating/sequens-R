...
**Planned Phase 7: Sound identity and mix.** The phase is divided into independent gates for the sound contract/test bench, Mixer, Drums, Bass, Acid, Chords, Arp, Piano, Euclid, CC Control, Mod, and final integration. It introduces specialized voices, versioned presets, shared delay/reverb, deliberate gain staging, live/bounce graph parity, loudness/true-peak analysis, legacy sound migration, and mandatory loudness-matched listening approval. Pattern generation and MIDI output remain unchanged. See the [complete Phase 7 specification](.agents/docs/phase-7-sound-quality.md).
