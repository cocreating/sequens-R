...
export interface VoiceIdentity {
  ...
  presetId: string;
  implementationId: 'procedural-drums-v2' | 'procedural-bass-v2' | 'procedural-acid-v2' | 'procedural-chords-v2' | 'procedural-arp-v2' | 'procedural-euclid-v2' | 'procedural-piano-v2' | 'legacy-drums-v1' | 'legacy-acid-v1' | 'legacy-poly-square-v1' | 'legacy-poly-triangle-v1' | 'silent-cc-v2' | 'silent-mod-v2' | 'silent-control-v1';
}
...
export class VoiceFactory {
  create(context: BaseAudioContext, module: VoiceModuleSnapshot, destination: AudioNode): InternalVoice | null {
    ...
    if (module.type === 'euclid' && module.sound.presetId !== 'legacy-euclid-v1') {
      return new EuclidVoice(context, destination, module.sound);
    }
      ...
      : module.type === 'drums'
        ...
        : module.type === 'acid'
          ...
          : module.type === 'chords'
            ...
            : module.type === 'euclid'
              ? module.sound.presetId === 'legacy-euclid-v1' ? 'legacy-poly-triangle-v1' : 'procedural-euclid-v2'
          : module.type === 'bass'
